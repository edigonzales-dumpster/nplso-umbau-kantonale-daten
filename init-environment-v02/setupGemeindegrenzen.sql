...
CREATE TABLE IF NOT EXISTS agi_hoheitsgrenzen_pub.hoheitsgrenzen_gemeindegrenze (
	t_id bigserial,
...
CREATE INDEX hohitsegrenzen_gemendgrnze_geometrie_idx ON agi_hoheitsgrenzen_pub.hoheitsgrenzen_gemeindegrenze USING GIST (geometrie);
